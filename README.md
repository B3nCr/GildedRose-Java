...
This is a translation of what I believe to be the original C# version of the Gilded Rose kata.

Who: [@TerryHughes](https://twitter.com/TerryHughes), [@NotMyself](https://twitter.com/NotMyself)

What & Why: [Refactor This: The Gilded Rose Kata (theorignial site appears to be gone so using an archive link)](https://web.archive.org/web/20200121165834/http://iamnotmyself.com/2011/02/14/refactor-this-the-gilded-rose-kata/)
